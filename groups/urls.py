...
company_patterns = [
  ...
  url(r'^invites/(?P<code>\w+)/(?P<response>accept|reject)/$', company.InviteResponse.as_view(), name = 'invite_response'),
...
family_patterns = [
  ...
  url(r'^invites/(?P<code>\w+)/(?P<response>accept|reject)/$', family.InviteResponse.as_view(), name = 'invite_response'),
